    ...
    <div class="footer">
        ...
        <div class="nav-links">
            <ul>
                ...
                <li>|</li>
                <li><a href="https://global.alipay.com/index.htm" target="_blank" seed="">International Business</a></li>

            </ul>
        </div>
        <div class="ownership">
            <span><a href="https://fun.alipay.com/certificate/jyxkz.htm">ICP证号：沪B2-20150087</a></span>
        </div>
        <div class="nav-icons">
		...
		<div id="ServerNum"><p>homeproxy-30-5072</p></div>
    </div>
</div>
